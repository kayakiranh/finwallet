...
public sealed class BankAccount
{
    ...
    public static BankAccount Create(Guid id, Guid customerId, Guid walletId, CurrencyCode currency, DateTimeOffset createdAt)
    {
    ...
    public static BankAccount Restore(Guid id, Guid customerId, Guid walletId, CurrencyCode currency, Guid? externalAccountId, string? externalIban, BankAccountStatus status, DateTimeOffset createdAt, DateTimeOffset updatedAt)
    {
        ValidateIdentifiers(id, customerId, walletId);
    ...
    /// <summary>TR: Aktif banka hesabını yeni finansal hareketlere kapatır. EN: Blocks an active bank account from new financial movements.</summary>
    ...
    /// <summary>TR: Bloke banka hesabını tekrar aktif duruma getirir. EN: Restores a blocked bank account to active state.</summary>
    ...
    /// <summary>TR: Active veya Blocked banka hesabı bağlantısını kalıcı Closed state'e geçirir. EN: Permanently closes an Active or Blocked bank-account connection.</summary>
    ...
    /// <summary>TR: External provider hesabının bağlı olduğunu doğrular. EN: Validates that an external provider account is linked.</summary>
